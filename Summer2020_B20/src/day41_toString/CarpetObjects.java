...
public class CarpetObjects {
    public static void main(String[] args) {
        ...
        carpets [1].customOrder(5.5,3.5, 17.5,true);
        carpets [2].customOrder(4.5, 5.5, 17.5, false);
        carpets [3].customOrder(3.5,4.5,17.5, true);
        carpets [4].customOrder(6.5, 5.5, 17.5, true);
