...
public class String_Methods_ReplaceNewOld {
    public static void main(String[] args) {
        ...
        int r3 = s5.indexOf("rnin");//returns the first char 'r' index
        ...
        String s7 = "Java";
        int a1 = s7.indexOf("A");//character doesn't exist in the String
