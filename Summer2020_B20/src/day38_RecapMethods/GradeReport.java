...
public class GradeReport {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(gradeA.size()+" students made B");
        System.out.println(gradeA.size()+" students made C");
        System.out.println(gradeA.size()+" students made D");
        System.out.println(gradeA.size()+" students failed");
    }
